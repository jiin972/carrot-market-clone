-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('for_sale', 'reserved', 'sold');
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_createdForId_fkey" FOREIGN KEY ("createdForId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
